...
## 🎯 step2 요구사항
1. 당첨 & 보너스 번호 확인 기능
- [] 당첨 번호 6개와 보너스 번호 1개는 1 ~ 45 중 중복되지 않은 7개의 수이다.
  - [] 당첨 번호와 보너스 번호 input에 하나라도 입력하지 않으면 alert 창이 뜬다.
  - [] 당첨 번호가 1 ~ 45 사이의 수가 아니면 alert창이 뜬다.
  - [] 보너스 번호가 1 ~ 45 사이의 수가 아니면 alert창이 뜬다.
  - [] 당첨 번호와 보너스 번호 중 중복되는 숫자가 있으면 alert창이 뜬다.
2. 결과 확인하기 기능
- [] 결과 확인하기 버튼을 누르면 당첨 통계, 수익률 결과가 있는 모달창이 뜬다.
  - [] 로또 당첨 금액은 고정되어 있는 것으로 가정한다.
3. 로또 다시 시작하기 기능
- [] 모달창의 다시 시작하기 버튼을 누르면 초기화 되어 로또 구매하기 전 화면으로 돌아간다.
