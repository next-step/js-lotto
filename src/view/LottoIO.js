...
class LottoIO {
    ...
    outputLottosResult(lottoResult, percent) {
        ...
        const result_sec = countArrayResults(lottoResult, isConditon(LOTTO_SECOND_PRIZE_WINNER));
        const result_first = countArrayResults(lottoResult, isConditon(LOTTO_FIRST_PRIZE_WINNER));
