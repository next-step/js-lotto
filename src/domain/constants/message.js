import { LOTTO_NUMBER_SEPARATOR, LOTTO_MIN_NUMBER, LOTTO_MAX_NUMBER } from './configure';
...
export const ERROR_MESSAGE = Object.freeze({
  ...
  INVALID_AMOUNT_BY_NOT_POSITIVE_AMOUNT: '로또 구입 금액은 음수가 될 수 없습니다.',
  ...
  INVALID_LOTTO_NUMBER_BY_NOT_NUMBER: '로또 번호는 숫자만 입력 가능합니다.',
  ...
  INVALID_BONUS_NUMBER_BY_NOT_NUMBER: '보너스 번호는 숫자만 입력 가능합니다.'
});
