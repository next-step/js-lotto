import { modalSelector, inputSelector, formSelector } from './constants/selectors.js';
import { $ } from './util.js';
import { closeModal, showModal, showLottoDetailNumbers, hideLottoDetailNumbers, showElement } from './view.js';
