import { PRICE_UNIT, LOTTO_CONSTRAINT } from './lottoConstraint.js';

export const ERROR_MESSAGE = {
  INVALID_PRICE_UNIT: `${PRICE_UNIT}원 단위의 구입 금액을 입력해주세요.`,
  INVALID_OVER_MIN_PRICE: `${PRICE_UNIT}원 이상의 구입 금액을 입력해주세요`,
