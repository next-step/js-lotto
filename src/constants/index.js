...
export const MESSAGE_BONUS_NUMBER = '> 보너스 번호를 입력해 주세요.';
export const MESSAGE_RESTART_OR_NOT = '다시 시작하시겠습니까? (y/n) ';

export const MIN_INPUT_NUMBERS_LENGTH = 1;
...
export const LOTTO_TOTAL_COUNT = 6;
