...
export default class FormDetailEntry extends View {
  ...
  constructor() {
    ...
    this.$toggle = $content.querySelector('input[type=checkbox]') as HTMLInputElement
    this.$inputs = Array.from($content.querySelectorAll('input[type="number"]')) as HTMLInputElement[]
