...
describe('복권 번호는 토글 버튼을 클릭하면 볼 수 있어야 한다.', () => {
  ...
  afterEach(() => cy.get('#input-toggle-button').uncheck({ force: true }));
